 ...
 */
async function queryByStringSWTransmgmt(stub, queryString) {
...
let Chaincode = class {
     ...
     *   }
     */
    async createSWTransmgmt(stub, args) {
     ...
     * @param {*} args 
     */
    async queryProfileTransmgmt(stub, args) {
    ...
    async queryAllTransmgmtHist(stub, args) {
