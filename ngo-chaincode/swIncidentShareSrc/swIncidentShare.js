 ...
 */
async function queryByStringIncidentShare(stub, queryString) {
...
let Chaincode = class {
     ...
     *   }
     */
    async createSWIncidentShare(stub, args) {
     ...
     * @param {*} args 
     */
    async queryIncidentShare(stub, args) {
    ...
    async queryAllIncidentShare(stub, args) {
        ...
        return queryByStringIncidentShare(stub, queryString);
    }
}
