 ...
 */
async function queryByStringIncident(stub, queryString) {
...
let Chaincode = class {
     ...
     *   }
     */
    async createSWIncident(stub, args) {
    ...
    async queryAllIncidentHist(stub, args) {
        ...
        return queryByStringIncident(stub, queryString);
    }
}
